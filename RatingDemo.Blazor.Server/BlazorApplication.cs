...
namespace RatingDemo.Blazor.Server {
    public partial class RatingDemoBlazorApplication : BlazorApplication {
        public RatingDemoBlazorApplication() {
            InitializeComponent();
        }
        ...
        private void RatingDemoBlazorApplication_DatabaseVersionMismatch(object sender, DatabaseVersionMismatchEventArgs e) {
#if EASYTEST
            e.Updater.Update();
            e.Handled = true;
#else
